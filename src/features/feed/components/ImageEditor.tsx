...
import { editorActions } from "@/shared/config/editor";
...
const ImageEditor = ({
  ...
  return (
    <div className="fixed top-0 left-0 z-99 flex h-screen w-screen items-center justify-center bg-black/50">
      <div className="flex flex-col rounded-xl bg-black/95 p-8">
        ...
        <div className="xs:h-[450px] xs:w-[400px] flex items-center md:h-[700px] md:w-[600px]">
          ...
          <Image
            ...
            className={`w-full ${settings.type === "original" ? "h-[400px] object-contain md:h-[650px]" : settings.type === "square" ? "aspect-square object-cover" : "aspect-video object-cover"}`}
