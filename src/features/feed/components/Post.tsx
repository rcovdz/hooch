import { TypeToast } from "@/shared/components/icons";
import { ImgComp, PostImg, PostVideo } from "@/shared/components/ui";
import { PostInteractions } from "./";
import { imagekit } from "@/shared/lib/utils";
import { IDetailResponse } from "@/types/media";
...
const Post = async () => {
  ...
  const fileDetails = await getFileDetails("688147225c7cd75eb8eaeba8");
